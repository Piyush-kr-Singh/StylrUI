...
const PrivacyPolicy = () => {
    return (
        <div className="max-w-4xl mx-auto p-8 mt-28">
            ...
            <p className="mb-4">
                At StylrUI, we are committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website stylr.com, use our services, or interact with us.
            </p>
            ...
            <ul className="list-disc list-inside mb-4">
                ...
                <li>Third-Party Service Providers: We may share your information with third parties that perform services for us or on our behalf, such as payment processing, data analysis, email delivery, hosting services, customer service, and marketing assistance.</li>
            </ul>
